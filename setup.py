...
keywords = [
    'Newspaper3K', "news-fetch", "without-api", "google_scraper", 'news_scraper',
    'bs4', 'lxml', 'news-crawler', 'news-extractor', 'crawler', 'extractor',
    'news', 'news-websites', 'elasticsearch', 'json', 'python', 'nlp',
    'data-gathering', 'news-archive', 'news-articles', 'commoncrawl',
    'extract-articles', 'extract-information', 'news-scraper', 'spacy'
]
